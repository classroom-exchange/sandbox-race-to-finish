...
const CIRCUITS = [
  ...
  { id:1, name:"Pattern Park",  icon:"🔁", color:"#f39c12",
    ...
    {
      label:"Mirror Straight",
      hint:"Same section twice — use the same commands! 🔁",
      start:{x:0,y:2}, startDir:"right",
      finish:{x:4,y:2}, obstacles:[],
      scaffold:["forward","forward",null,"forward","forward",null],
      trackPath:[{x:0,y:2},{x:1,y:2},{x:2,y:2},{x:3,y:2},{x:4,y:2}],
    },
    {
      label:"Double Loop",
      hint:"Two corners, same pattern each time! 🔄",
      start:{x:0,y:0}, startDir:"right",
      finish:{x:4,y:4}, obstacles:[],
      scaffold:["forward","forward",null,"forward",null,"forward","forward",null,"forward",null],
      trackPath:[
    ...
    {
      label:"Zigzag Park",
      hint:"Left, right, left, right — feel the rhythm! ⚡",
      start:{x:0,y:0}, startDir:"right",
      finish:{x:4,y:4}, obstacles:[],
      scaffold:["forward",null,"forward",null,"forward",null,"forward",null,"forward"],
      trackPath:[
        {x:0,y:0},{x:1,y:0},
        {x:1,y:1},{x:1,y:2},
        {x:2,y:2},{x:3,y:2},
    ...
    },
    {
      ...
      hint:"Three sections, one pattern — you've got this! 🏆",
      start:{x:0,y:0}, startDir:"right",
      finish:{x:4,y:0}, obstacles:[],
      scaffold:["forward",null,null,"forward",null,null,"forward",null,null],
      trackPath:[
