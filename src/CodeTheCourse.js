    ...
    description:"Spot the patterns!",                 levels:[
      {
        ...
        start:{x:0,y:1}, startDir:'right',
        finish:{x:3,y:4}, obstacles:[],
        scaffold:['forward','turnLeft','forward','repeat(2)'],
      },
      {
        label: 'Pattern Park - Level 3',
        hint: 'Identify the repeating pattern and fill in the gaps!',
        start:{x:0,y:1}, startDir:'right',
        finish:{x:4,y:5}, obstacles:[],
        scaffold:['forward','turnRight','repeat(2)','forward'],
      },
      {
        label: 'Pattern Park - Level 4',
        hint: 'Complete the track using repeating patterns!',
        start:{x:0,y:1}, startDir:'right',
        finish:{x:5,y:6}, obstacles:[],
        scaffold:['forward','turnLeft','repeat(3)','turnRight'],
      },
    ] },
  { id:1, name:"Pattern Park",  icon:"🔁", color:"#f39c12",
    description:"Spot the patterns!",                 levels:[] },
